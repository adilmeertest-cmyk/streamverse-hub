  ...
  return (
    ...
    >
      <div className="relative aspect-[2/3] overflow-hidden">
        {t.poster_url ? (
          <img src={t.poster_url} alt={t.title} loading="lazy" decoding="async" className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" />
        ) : (
